...
# S3 Bucket for storing audio/video files
...
resource "aws_elasticache_replication_group" "redis" {
  ...
  description                  = "Redis cluster for baby monitor"
...
resource "aws_cloudwatch_log_group" "ml_worker" {
  name              = "/ecs/${var.project_name}/ml-worker"
  retention_in_days = 7

  tags = {
    Name = "${var.project_name}-ml-worker-logs"
  }
}
