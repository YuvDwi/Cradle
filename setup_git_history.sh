...
# Smart Baby Monitor - Git History Setup Script
...
# Calculate dates (2 weeks ago to today)
...
DATE1=$(date -d '14 days ago' '+%Y-%m-%d')
...
DATE2=$(date -d '13 days ago' '+%Y-%m-%d')
...
DATE3=$(date -d '12 days ago' '+%Y-%m-%d')
...
DATE10=$(date -d '5 days ago' '+%Y-%m-%d')
...
DATE11=$(date -d '4 days ago' '+%Y-%m-%d')
...
DATE12=$(date -d '3 days ago' '+%Y-%m-%d')
...
DATE13=$(date -d '2 days ago' '+%Y-%m-%d')
...
echo ""
echo "Your Smart Baby Monitor project is ready to impress!"
